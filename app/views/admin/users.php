<div id="users" class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form class="mb-4" action="/admin/users" method="GET">
            ...
            <div class="search-results">
                <?php foreach ($model->users as $user) : ?>
                    <a href="/admin/user/<?= $user['username'] ?>" class="text-decoration-none">
                        <div class="card mb-3">
                            <div class="user-detail d-flex align-items-center p-3">
                                ...
                                <?php else : ?>
                                    <img src="/resources/images/default_avatar.jpg" width="50" height="50" class="user-icon rounded-circle me-3">
                                <?php endif; ?>
                                <div>
