...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="/questwise/resources/icon.png" type="image/png">

    <!-- External CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">

    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="/questwise/resources/css/custom.css">
    ...
    <meta property="og:image" content="/questwise/resources/images/questwise.png">
    ...
    <meta name="twitter:image" content="/questwise/resources/images/questwise.png">
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/questwise/">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/questwise/">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/questwise/quests">Quests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/questwise/achievements">Achievements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/questwise/users">Users</a>
                    </li>
                    <?php if (isset($_SESSION['username'])) : ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <?php else : ?>
                                    <img src="/questwise/resources/images/default_avatar.jpg" id="userAvatar" alt="User Avatar" width="30" height="30" class="rounded-circle">
                                <?php endif; ?>
                                <?php echo $_SESSION['username']; ?>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="/questwise/user/<?= $_SESSION['username'] ?>">Profile</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/questwise/logout">Logout</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <div class="points-display shadow-sm">
                                <span class="points-icon">
                                    <img src="/questwise/resources/images/point.png" alt="Point Icon" width="20" height="20">
                                </span>
    ...
    <!-- Custom JS -->
    <script src="/questwise/resources/js/custom.js" defer></script>
    <?php
    $contentViewJsPath = str_replace('.php', '.js', $contentView); // Replaces ".php" with ".js"
    $contentViewJsPath = str_replace('../app/views/', '/questwise/resources/js/', $contentViewJsPath); // Replaces the path segment
